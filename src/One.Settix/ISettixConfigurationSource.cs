...
{
    public interface ISettixConfigurationSource : IConfigurationSource
    {
        Settix Settix { get; }
        ...
        /// </summary>
        Action<SettixConfigurationProvider> ChangeTokenConsumer { get; set; }

        /// <summary>
        /// A trigger notification that the configuration source has changed and a reload is required.
        /// </summary>
        ISettixWatcher ReloadWatcher { get; set; }
    }
}
